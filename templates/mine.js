...
$(function(){
    ...
    $("#submit").click(function () {
        ...
        formData.append('upload_langcode', '{{lang_code}}');

        $(this).prop('disabled', true).removeClass('btn-success').addClass('btn-primary').text('{{uploading}}');
        $.ajax({
            ...
            error: function(response) {
                ...
                alert('{{oops}}' + response.responseText)
                $("#submit").prop('disabled', false).removeClass('btn-primary').addClass('btn-success').text('{{submit}}');
            }
        });
    });
